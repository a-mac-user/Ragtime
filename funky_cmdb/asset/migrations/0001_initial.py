# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2018-01-27 20:39
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('asset_type', models.CharField(choices=[('server', '服务器'), ('networkdevice', '网络设备'), ('storagedevice', '储存设备'), ('securitydevice', '安全设备'), ('idcdevice', '机房设备'), ('software', '软件资产')], default='server', max_length=64, verbose_name='资产类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(blank=True, verbose_name='合同开始日期')),
                ('end_date', models.DateField(blank=True, verbose_name='合同结束日期')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='asset.Asset', verbose_name='资产')),
            ],
            options={
                'verbose_name': 'CPU',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iface_type', models.CharField(choices=[('SATA', 'SATA'), ('SAS', 'SAS'), ('SCSI', 'SCSI')], default='SAS', max_length=64, verbose_name='接口类型')),
                ('memo', models.TextField(blank=True, null=True, verbose_name='备注')),
                ('create_date', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('update_date', models.DateTimeField(blank=True, null=True, verbose_name='更新时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('os_distribution', models.CharField(blank=True, max_length=64, null=True, verbose_name='OS发行版本')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('macaddress', models.CharField(max_length=64, unique=True, verbose_name='MAC address')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by_type', models.CharField(choices=[('auto', '自动创建'), ('manual', '手动创建')], default='auto', max_length=64, verbose_name='创建类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_asset_type', models.SmallIntegerField(choices=[(0, '操作系统'), (1, '办公\\开发软件'), (2, '业务软件'), (3, '固件')], default=0, verbose_name='软件类型')),
        ...
        migrations.AddField(
            ...
            name='firmware',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='asset.Software', verbose_name='固件'),
        ),
        migrations.AddField(
            model_name='asset',
            name='business_unit',
